...
export const SignUp = async ({password , ...userData }:SignUpParams) => {
    ...
    try {
        ...
        const dwollerCustomerId = extractCustomerIdFromUrl(dwollaCustomerUrl);
        
        console.log('The user_collection_id:' ,dwollerCustomerId)
...
export const createBankAccount = async({
    ...
    try{
        ...
        console.log('The user_collection_id:' ,USER_COLLECTION_ID)
